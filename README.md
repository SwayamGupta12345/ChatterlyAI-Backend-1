...
# ChatterlyAI — Helper Socket Server (ChatterlyAI-Backend-1)
...
## Quickstart — local
```
git clone https://github.com/SwayamGupta12345/ChatterlyAI-Backend-1.git
cd ChatterlyAI-Backend-1
npm install
...
## Maintainer
SwayamGupta12345 | swayamsam2005@gmail.com
